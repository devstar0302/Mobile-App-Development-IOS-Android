 ...
 */
static NSString * const kConsumerKey       = YelpConsumerKey;
static NSString * const kConsumerSecret    = YelpConsumerSecret;
static NSString * const kToken             = YelpToken;
static NSString * const kTokenSecret       = YelpTokenSecret;
